...
import cn.virtuepay.exception.ChannelException;
import cn.virtuepay.model.Payment;
import cn.virtuepay.util.WxpubOAuth;
...
public class WxPubOAuthExample {
    ...
    /**
     * VirtuePay 管理平台对应的应用 ID，app_id 获取方式：登录 [Dashboard](https://dashboard.virtuepay.cn)->点击你创建的应用->应用首页->应用 ID(App ID)
     */
