 ...
 * 接入退款流程参考开发者中心：https://virtuepay.cn/docs/server/refund ，文档可筛选后端语言和接入渠道。
 ...
 * 退款相关示例
 *
 * 该实例程序演示了如何从 VirtuePay 服务器进行退款操作。
 *
...
public class RefundExample {
     ...
     * 参数具体说明参考：https://virtuepay.cn/api#api-r-new
     *
     * 可以一次退款，也可以分批退款。
     *
     * @param amount
     ...
     * 参考文档：https://virtuepay.cn/api#api-r-inquiry
     *
     * @param id
     */
     ...
     * 参考文档：https://virtuepay.cn/api#api-r-list
     *
     */
    public void all() {
        if (payment == null) {
