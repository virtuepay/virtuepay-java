...
具体使用示例参考 [RequestOptionsTest.java](/src/test/java/com/virtuepay/RequestOptionsTest.java)
...
`VirtuePay.AcceptLanguage` 改为 `VirtuePay.acceptLanguage`。
...
VirtuePayResponse response = payment.getLastResponse();
