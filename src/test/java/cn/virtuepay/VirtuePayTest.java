...
public class VirtuePayTest {
    ...
    public void testSetApiKey() {
        assertEquals("apiKey should be set", "sk_test_ibbTe5jLGCi5rzfH4OqPW9KC", VirtuePay.apiKey);
    }
    ...
    public void testCreatePayment() {
        ...
        pamentMap.put("channel", "wx_wap");// 支付使用的第三方支付渠道取值，请参考：https://virtuepay.cn/api#api-c-new
