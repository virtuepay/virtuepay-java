...
public class RequestOptions {
    ...
    public static RequestOptions getDefault() {
        return new RequestOptions(
                VirtuePay.apiKey,
                VirtuePay.appId,
                VirtuePay.privateKey,
                VirtuePay.getConnectTimeout(),
                VirtuePay.getReadTimeout(),
                VirtuePay.getMaxNetworkRetries(),
                VirtuePay.getAcceptLanguage());
    }
    ...
    public static final class RequestOptionsBuilder {
        ...
        public RequestOptionsBuilder() {
            this.apiKey = VirtuePay.apiKey;
            this.appId = VirtuePay.appId;
            this.privateKey = VirtuePay.privateKey;
            this.connectTimeout = VirtuePay.getConnectTimeout();
            this.readTimeout = VirtuePay.getReadTimeout();
            this.maxNetworkRetries = VirtuePay.getMaxNetworkRetries();
            this.acceptLanguage = VirtuePay.getAcceptLanguage();
        }
